...
public class WeChatModule extends ReactContextBaseJavaModule implements IWXAPIEventHandler {
    ...
    @ReactMethod
    public void registerApp(String appid, String ulink, Callback callback) {
        this.appId = appid;
    ...
    @ReactMethod
    public void goKf(String corpid, String url,  final Callback callback) {
    ...
    @ReactMethod
    public void goQQKf(String url,  final Callback callback) {
